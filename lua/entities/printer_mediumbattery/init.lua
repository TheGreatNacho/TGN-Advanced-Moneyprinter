...
local classname = "printer_mediumbattery" -- This should be the name of the folder containing this file.
...
function ENT:Touch(ent)
	if self:GetNWInt("dhold")==0 then
		if (ent:GetClass() == "adv_moneyprinter") then
			...
			self:Remove()
			ent:AddPower(Config.DefaultMaxPower/2)
		end
	end
end


--Copyright �TheGreatNacho", 2013